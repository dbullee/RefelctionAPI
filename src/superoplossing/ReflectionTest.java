...
public class ReflectionTest {
	...
	public void init(){
		...
		consumerObject.setFirstName("Iemand");
		consumerObject.setLastName("Anders");
		String[] itemsConsumer = {"Sok", "Shirt", "Broek"};
		consumerObject.setItems(itemsConsumer);
		consumerObject.setMoney(1000);
		consumerClass = consumerObject.getClass();
	}
	...
	/**
	 * Test the getSuperClass() method for subclasses via the Reflection API
	 */
	@Test
	...
	/**
	 * Test the getInterfaces() method for classes using an interface via the Reflection API
	 */
	@Test
	public void usesInterfaceTest(){
		Class<?>[] interfaces = personClass.getInterfaces();
		assertNotNull(interfaces[0]);
	}
}
